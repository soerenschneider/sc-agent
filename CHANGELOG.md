...
* fix potential data race ([a6c70c9](https://github.com/soerenschneider/sc-agent/commit/a6c70c96f423e1014b0575b5be8a8d81274dc538))
...
* fix unreachable code ([110fb0e](https://github.com/soerenschneider/sc-agent/commit/110fb0e069211aa0f88ad1d9389940ccee600fed))
...
* add feature to write full ca-chain to issued certs ([938747c](https://github.com/soerenschneider/sc-agent/commit/938747c7025e842435fd7fc22b53d35b064294da))
...
* initial support for mqtt adapter ([8cb4ce8](https://github.com/soerenschneider/sc-agent/commit/8cb4ce8ee6bba613004e95e22e27628258fb0cf9))
...
* write full ca-chain ([aa76c92](https://github.com/soerenschneider/sc-agent/commit/aa76c924edf05008825352cfef7033b9e0f94d5d))
...
* **deps:** bump github.com/caarlos0/env/v11 from 11.2.2 to 11.3.1 ([d9d0b9b](https://github.com/soerenschneider/sc-agent/commit/d9d0b9b19f057ad1b77e6d0634684966f9973aef))
...
* **deps:** bump github.com/getkin/kin-openapi from 0.127.0 to 0.128.0 ([92f3395](https://github.com/soerenschneider/sc-agent/commit/92f3395a60be6b98a22fc8e242da7b8cc3174087))
...
* **deps:** bump github.com/go-playground/validator/v10 from 10.22.0 to 10.22.1 ([f27bd94](https://github.com/soerenschneider/sc-agent/commit/f27bd946a56be3266da51db99c2b262e0117e42d))
* **deps:** bump github.com/go-playground/validator/v10 from 10.22.1 to 10.23.0 ([e974418](https://github.com/soerenschneider/sc-agent/commit/e974418fd0d83298f92b91557bda65cb8aeb6e4f))
...
* **deps:** bump github.com/hashicorp/vault/api from 1.14.0 to 1.15.0 ([30a83fc](https://github.com/soerenschneider/sc-agent/commit/30a83fc547f8d80ddb016944be4ebe78b0c04e3f))
...
* **deps:** bump github.com/oapi-codegen/oapi-codegen/v2 from 2.3.0 to 2.4.1 ([3bd8bb1](https://github.com/soerenschneider/sc-agent/commit/3bd8bb1c5ea214edcf455882a2139dfbcfcd81fe))
...
* **deps:** bump github.com/prometheus-community/pro-bing from 0.4.1 to 0.6.1 ([955c402](https://github.com/soerenschneider/sc-agent/commit/955c402f24ca1779e309cb5d06447cde2d0d57b5))
...
* **deps:** bump github.com/prometheus/client_golang from 1.20.0 to 1.20.1 ([e7d2626](https://github.com/soerenschneider/sc-agent/commit/e7d26267fa9e996aa5f24feae0914f85a13d71bf))
* **deps:** bump github.com/prometheus/client_golang from 1.20.1 to 1.20.2 ([0c9d742](https://github.com/soerenschneider/sc-agent/commit/0c9d742796edb8710e2a2252e2e55d4faacc53ce))
* **deps:** bump github.com/prometheus/client_golang from 1.20.2 to 1.20.3 ([cd08fec](https://github.com/soerenschneider/sc-agent/commit/cd08feced3f6b3a2ad0e56a978d4c5d74dfe71b3))
* **deps:** bump github.com/prometheus/client_golang from 1.20.3 to 1.20.4 ([ea8993a](https://github.com/soerenschneider/sc-agent/commit/ea8993a5cf23997c3fd6312a91f72f8f08e82b54))
* **deps:** bump github.com/prometheus/client_golang from 1.20.4 to 1.20.5 ([8eea385](https://github.com/soerenschneider/sc-agent/commit/8eea385b77a9f8b60d1be984f492eff48546393c))
...
* **deps:** bump github.com/prometheus/common from 0.55.0 to 0.57.0 ([c34a6e1](https://github.com/soerenschneider/sc-agent/commit/c34a6e1726b0b0fb8853ecaebe003db2c4614e67))
...
* **deps:** bump github.com/prometheus/common from 0.57.0 to 0.59.1 ([1003ec9](https://github.com/soerenschneider/sc-agent/commit/1003ec9f12259cade09e027a0b11547ab64fbd84))
...
* **deps:** bump github.com/prometheus/common from 0.59.1 to 0.60.0 ([04aeecb](https://github.com/soerenschneider/sc-agent/commit/04aeecbe15de9c883f2af758efa45d67c04935cb))
...
* **deps:** bump github.com/prometheus/common from 0.60.0 to 0.60.1 ([d63c6ce](https://github.com/soerenschneider/sc-agent/commit/d63c6ce71c4a973e74627726ada6fb7ca4fddcac))
...
* **deps:** bump github.com/prometheus/common from 0.60.1 to 0.62.0 ([7a00553](https://github.com/soerenschneider/sc-agent/commit/7a005536ce95bf2df89f73bee4e77ee8e51b107e))
...
* **deps:** bump github.com/zcalusic/sysinfo from 1.1.2 to 1.1.3 ([273f24e](https://github.com/soerenschneider/sc-agent/commit/273f24edc026ee847f8598ceaaed3502494c268e))
...
* **deps:** bump golang from 1.23.0 to 1.23.1 ([96bb6df](https://github.com/soerenschneider/sc-agent/commit/96bb6df372efea439fd5710d95312c4a033663de))
...
* **deps:** bump golang from 1.23.1 to 1.23.2 ([862d497](https://github.com/soerenschneider/sc-agent/commit/862d4977f83565e4df76998c9060a3e6d3918622))
...
* **deps:** bump golang from 1.23.2 to 1.23.4 ([b9a0f88](https://github.com/soerenschneider/sc-agent/commit/b9a0f88e13ec339a27190081d9c3eb4defb58bf5))
...
* **deps:** bump golang from 1.23.4 to 1.24.0 ([154905d](https://github.com/soerenschneider/sc-agent/commit/154905d7efe7c976f24f1d86b08aa24d5001e438))
...
* **deps:** bump golang.org/x/crypto from 0.26.0 to 0.27.0 ([de10f26](https://github.com/soerenschneider/sc-agent/commit/de10f268fe6dc7148cd4cc33e1ff917f0e47897a))
...
* **deps:** bump golang.org/x/crypto from 0.27.0 to 0.28.0 ([a5c96f3](https://github.com/soerenschneider/sc-agent/commit/a5c96f34bb89a23187b349ac1789bcef671555b8))
...
* **deps:** bump golang.org/x/crypto from 0.28.0 to 0.33.0 ([1a5940d](https://github.com/soerenschneider/sc-agent/commit/1a5940d2991de0d33dbf9bbe32c7c86eecfd2a28))
...
* **deps:** bump golang.org/x/term from 0.23.0 to 0.24.0 ([ebed41f](https://github.com/soerenschneider/sc-agent/commit/ebed41fc46ceb5905e0771165db0debfb703add7))
...
* **deps:** bump golang.org/x/term from 0.24.0 to 0.25.0 ([a4c20c3](https://github.com/soerenschneider/sc-agent/commit/a4c20c3ace6bd21297d981031393682837cdaf03))
...
* **deps:** bump golang.org/x/term from 0.25.0 to 0.28.0 ([df30611](https://github.com/soerenschneider/sc-agent/commit/df30611bca5a165b07d98ad6f45184ce4b25a437))
...
## [1.11.0](https://github.com/soerenschneider/sc-agent/compare/v1.10.0...v1.11.0) (2025-08-04)

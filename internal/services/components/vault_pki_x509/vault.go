...
type VaultX509PkiOpts func(v *VaultX509Client) error

func New(client VaultClient, opts ...VaultX509PkiOpts) (*VaultX509Client, error) {
	if client == nil {
...
func (v *VaultX509Client) Issue(ctx context.Context, req domain.CertConfig) (*pki.CertData, error) {
...
func getVaultIssueRequest(req domain.CertConfig) map[string]any {
